...
実際に AWS account `429488498071` に対して構築した時の **実出力** を載せている。
...
export AWS_PROFILE=AdministratorAccess-429488498071  # 自分のプロファイル名に置き換え
```
...
```json
{
    "UserId": "AROAWH74CMWLVO3OEJNQM:noguchi@nogu-lab.com",
    "Account": "429488498071",
    "Arn": "arn:aws:sts::429488498071:assumed-role/AWSReservedSSO_AdministratorAccess_1e32b5d70dc032ec/noguchi@nogu-lab.com"
}
```
...
```json
{
    "OpenIDConnectProviderList": [
        {
            "Arn": "arn:aws:iam::429488498071:oidc-provider/token.actions.githubusercontent.com"
        }
    ]
}
```
...
```json
{
    "Role": {
        ...
        "RoleId": "AROAWH74CMWLU7ONEVZZH",
        "Arn": "arn:aws:iam::429488498071:role/GitHubActionsRole",
...
```
arn:aws:iam::429488498071:role/GitHubActionsRole
```
...
```
NAME              VALUE                                              UPDATED
AWS_IAM_ROLE_ARN  arn:aws:iam::429488498071:role/GitHubActionsRole   less than a minute ago
```
...
{
    "UserId": "AROAWH74CMWLU7ONEVZZH:GitHubActions",
    "Account": "429488498071",
    "Arn": "arn:aws:sts::429488498071:assumed-role/GitHubActionsRole/GitHubActions"
}
```
...
- `UserId` のプレフィックス (`AROAxxxxx`) が Step 2-3 で作った Role の RoleId と一致 (例: `AROAWH74CMWLU7ONEVZZH`)
